...
def load_and_cache_examples(
        ...
        dataset_type='identification_classification'
        ) -> Tuple[TensorDataset, List[ContractNLIExample], List[Union[IdentificationClassificationFeatures, ClassificationFeatures]]]:
    try:
    ...
    cachename = f'cached_{filename}_{dataset_type}_{tokenizer_name}_{max_seq_length}_{max_query_length}_{doc_stride}'
